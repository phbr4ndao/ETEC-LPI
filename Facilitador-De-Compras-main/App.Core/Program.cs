...
string path = $"{Environment.CurrentDirectory}\\lista_de_produto_para_comprar-2.csv";
...
{
    StreamWriter streamWriter = new StreamWriter($"{Environment.CurrentDirectory}\\ListaDeCompras\\{Regex.Replace(mercadoModel1.Nome, "[^A-Za-z0-9]", "_")}.txt");
